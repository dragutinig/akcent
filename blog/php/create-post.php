...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        $post_id = $stmt->insert_id; // Preuzimanje ID-a novog posta
        ...
        echo "Greška pri kreiranju posta: " . $db->error;
    }
}

// Povezivanje sa bazom za preuzimanje kategorija
$database = new Database();
$db = $database->connect();
